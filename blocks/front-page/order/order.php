      ...
      <div class="wrapper">
        ...
        <div class="row row--nopadding">
          <div class="col-lg-8 ds-visible">
            <object
            type="image/svg+xml"
            data="<?php  echo esc_url( get_template_directory_uri() )  ?>/blocks/front-page/order/img/order-house.svg" class="order__promo">
            </object>
          </div>
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
            <form action="" class="form-order">
              <filedset class="form-order__fieldset">
              ...
              <div class="form-order__submit-wrapper">
                <input type="submit" class="form-order__submit" value="Заказать консультацию"></div>
                </filedset>
              </form>
            </div>
          </div>
