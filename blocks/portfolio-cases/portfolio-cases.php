<section class="portfolio-cases">
    ...
    <div class="wrapper">
    	...
    	<div class="portfolio-cases__korpus">
    		...
    		<input type="radio" id="portfolio-cases__tab_projects" checked>
    		<label class="portfolio-cases__korpus-tab" for="vkl1">Проекты</label>

    		<input type="radio" id="portfolio-cases__tab_presentation">
    		<label class="portfolio-cases__korpus-tab" for="vkl2">Презентация</label>

    		<input type="radio" id="">
    		<label class="portfolio-cases__korpus-tab" for="vkl3">Подробно</label>
